...
int main() {
	...
	newCards = 3;
	printf("hand count = %d, expected = %d\n", testG.handCount[thisPlayer], preHandCount + newCards - discarded);
	assert(testG.handCount[thisPlayer] == preHandCount + newCards - discarded);
	...
	// memcpy(&testG, &G, sizeof(struct gameState));
	// choice1 = 2;
	// cardEffect(4, choice1, choice2, choice3, &testG, handpos, &bonus);
